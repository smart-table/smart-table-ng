...
import { SmartTable as ISmartTable, DisplayedItem, ProcessingOptions, FilterConfiguration, DisplayChangeCallback, SearchConfiguration, SliceConfiguration, SortConfiguration, TableState } from 'smart-table-core';
export declare abstract class SmartTable<T> implements ISmartTable<T>, OnDestroy {
